...
for chem in data:
    ...
    # Create chemical directory
    chem_path = f'chemicals/{en_slug}'
    os.makedirs(chem_path, exist_ok=True)
    
    # Create chemical index page (listing all materials)
    # ... (simplified - just create material subpages)
    
    # Create material subpages
...
print(f"✅ Added {chemicals_added} chemicals, {pages_created} pages")
