...
# More chemicals with correct German names
MORE_CHEMS = {
    ...
    'Salzwasser, Meerwasser': 'seawater',
...
for chem in data:
    if chem['name'] not in MORE_CHEMS:
        continue
    
    en_slug = MORE_CHEMS[chem['name']]
    
    if en_slug in processed or os.path.exists(f'chemicals/{en_slug}'):
        continue
