...
chemicalHazardDB["Eosin Y"] = {
  ...
  synonyms: ["Acid Red 87", "CI 45380", "Eosin yellowish"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Histology counterstain (H&E staining). Red/pink fluorescent dye." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
...
chemicalHazardDB["Sudan III"] = {
  ...
  de: "Sudan III", es: "Sudán III", fr: "Soudan III", pt: "Sudão III",
  synonyms: ["Solvent Red 23", "CI 26100", "Fat Red"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Fat/lipid stain. Used in food fraud detection (illegal red coloring)." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Sudan III" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Rhodamine B"] = {
  cas: "81-88-9", formula: "C₂₈H₃₁ClN₂O₃",
  de: "Rhodamin B", es: "Rodamina B", fr: "Rhodamine B", pt: "Rodamina B",
  synonyms: ["Basic Violet 10", "CI 45170", "Tetraethylrhodamine"],
  classes: ["irritant", "health"],
  ghs: ["GHS07", "GHS08"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Fluorescent tracer, laser dye. ILLEGAL in food (carcinogenic). Pink/red." },
  storage: { cabinet: "General storage", temp: "Room temperature, dark", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Rhodamine B" },
...
chemicalHazardDB["Hydrofluoric Acid (Buffered)"] = {
  cas: "7664-39-3", formula: "HF",
  de: "Flusssäure (gepuffert)", es: "Ácido fluorhídrico (tamponado)", fr: "Acide fluorhydrique (tamponné)", pt: "Ácido fluorídrico (tamponado)",
  synonyms: ["BOE", "Buffered oxide etch", "BHF"],
  classes: ["toxic", "corrosive"],
  ghs: ["GHS05", "GHS06"],
  hazardStatements: [
    { code: "H300", text: "Fatal if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Double nitrile + neoprene gloves, full suit" }, respiratory: { required: true, type: "Acid gas respirator" }, other: "EXTREMELY DANGEROUS. Calcium gluconate gel required. Can cause fatal hypocalcemia. Semiconductor etching." },
  storage: { cabinet: "HF-rated cabinet (HDPE)", temp: "Cool", ventilation: "Excellent", incompatible: ["Glass", "Concrete", "Metals", "Bases"] },
  transport: { un: "1790", class: "8 (6.1)", packingGroup: "II", properShipping: "Hydrofluoric acid" },
  firstAid: { inhalation: "Fresh air. IMMEDIATE medical attention.", skin: "Flush, apply calcium gluconate gel. IMMEDIATE medical attention.", eyes: "Flush 30 min. IMMEDIATE medical attention.", ingestion: "Drink milk/antacids. IMMEDIATE medical attention." }
};

chemicalHazardDB["Phosphoric Acid (Electronic Grade)"] = {
  cas: "7664-38-2", formula: "H₃PO₄",
  de: "Phosphorsäure (Elektronikqualität)", es: "Ácido fosfórico (grado electrónico)", fr: "Acide phosphorique (qualité électronique)", pt: "Ácido fosfórico (grau eletrônico)",
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "Ventilation" }, other: "Semiconductor cleaning, rust removal, food acidulant." },
  storage: { cabinet: "Acid cabinet", temp: "Room temperature", ventilation: "Normal", incompatible: ["Bases", "Metals"] },
  transport: { un: "1805", class: "8", packingGroup: "III", properShipping: "Phosphoric acid" },
...
chemicalHazardDB["Tetramethylammonium Hydroxide"] = {
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Butyl rubber gloves, full suit" }, respiratory: { required: true, type: "Ammonia-rated respirator" }, other: "Photoresist developer. NEUROTOXIN - can cause fatal cardiac arrest. Multiple fatalities reported in semiconductor fabs." },
  storage: { cabinet: "Toxic/corrosive storage", temp: "Cool", ventilation: "Excellent", incompatible: ["Acids", "Oxidizers"] },
  transport: { un: "1835", class: "8", packingGroup: "II", properShipping: "Tetramethylammonium hydroxide" },
  firstAid: { inhalation: "Fresh air. IMMEDIATE medical attention.", skin: "Flush 30 min. IMMEDIATE medical attention.", eyes: "Flush 30 min. IMMEDIATE medical attention.", ingestion: "Rinse mouth. IMMEDIATE medical attention." }
};

chemicalHazardDB["Isopropyl Alcohol (Electronic Grade)"] = {
  cas: "67-63-0", formula: "C₃H₇OH",
  de: "Isopropylalkohol (Elektronikqualität)", es: "Alcohol isopropílico (grado electrónico)", fr: "Alcool isopropylique (qualité électronique)", pt: "Álcool isopropílico (grau eletrônico)",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Gloves for prolonged contact" }, respiratory: { required: true, type: "Organic vapor respirator at high concentrations" }, other: "Ultra-pure grade for wafer cleaning. Common solvent." },
  storage: { cabinet: "Flammable cabinet", temp: "Cool", ventilation: "Well-ventilated", incompatible: ["Strong oxidizers", "Acids"] },
  transport: { un: "1219", class: "3", packingGroup: "II", properShipping: "Isopropanol" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth. Medical attention if large amount." }
};
...
chemicalHazardDB["Diisononyl Phthalate"] = {
  ...
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Gloves for prolonged contact" }, respiratory: { required: false, type: "Ventilation" }, other: "PVC plasticizer. Safer replacement for DEHP. Lower migration." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Diisononyl phthalate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Tributyl Citrate"] = {
  cas: "77-94-1", formula: "C₁₈H₃₂O₇",
  de: "Tributylcitrat", es: "Citrato de tributilo", fr: "Citrate de tributyle", pt: "Citrato de tributila",
  synonyms: ["TBC", "Citroflex 4"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Ventilation" }, other: "Non-toxic plasticizer. Food-contact approved. Nail polish, cosmetics." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Tributyl citrate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Generally safe." }
};

chemicalHazardDB["Epoxidized Soybean Oil"] = {
  cas: "8013-07-8", formula: "Various",
  de: "Epoxidiertes Sojaöl", es: "Aceite de soja epoxidado", fr: "Huile de soja époxydée", pt: "Óleo de soja epoxidado",
  synonyms: ["ESBO", "ESO"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Bio-based plasticizer/stabilizer for PVC. Food-contact approved (E number pending)." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids", "Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Epoxidized soybean oil" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Generally safe." }
};
...
chemicalHazardDB["Monosodium Glutamate"] = {
  ...
  synonyms: ["MSG", "E621", "Umami seasoning"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Flavor enhancer (umami). Generally safe. 'MSG symptom complex' is not scientifically supported." },
  storage: { cabinet: "General storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Monosodium glutamate" },
...
chemicalHazardDB["Chloramine-T"] = {
  ...
  de: "Chloramin-T", es: "Cloramina-T", fr: "Chloramine-T", pt: "Cloramina-T",
  synonyms: ["Tosylchloramide sodium", "Chloraseptin"],
  classes: ["oxidizer", "irritant"],
  ghs: ["GHS03", "GHS07"],
  hazardStatements: [
    { code: "H272", text: "May intensify fire; oxidizer" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "Dust mask, ventilation" }, other: "Disinfectant, wound antiseptic. Can cause occupational asthma." },
  storage: { cabinet: "Oxidizer storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Reducing agents", "Acids", "Ammonia"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Chloramine-T" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Zinc Sulfate Heptahydrate"] = {
  ...
  de: "Zinksulfat-Heptahydrat", es: "Sulfato de zinc heptahidratado", fr: "Sulfate de zinc heptahydraté", pt: "Sulfato de zinco hepta-hidratado",
  synonyms: ["White vitriol", "Zinc vitriol"],
  classes: ["irritant", "environmental"],
  ghs: ["GHS07", "GHS09"],
  hazardStatements: [
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Fertilizer (Zn source), dietary supplement, mordant, wood preservative." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases", "Phosphates"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Zinc sulfate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth. Medical attention." }
};

chemicalHazardDB["Iron(III) Chloride Hexahydrate"] = {
  cas: "10025-77-1", formula: "FeCl₃·6H₂O",
  de: "Eisen(III)-chlorid-Hexahydrat", es: "Cloruro férrico hexahidratado", fr: "Chlorure ferrique hexahydraté", pt: "Cloreto férrico hexa-hidratado",
  synonyms: ["Ferric chloride", "Iron trichloride"],
  classes: ["corrosive"],
  ghs: ["GHS05", "GHS07"],
  hazardStatements: [
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "PCB etching, water treatment, mordant. Yellow-brown, hygroscopic." },
...
chemicalHazardDB["Chromium(III) Chloride"] = {
  cas: "10025-73-7", formula: "CrCl₃",
  de: "Chrom(III)-chlorid", es: "Cloruro de cromo(III)", fr: "Chlorure de chrome(III)", pt: "Cloreto de cromo(III)",
  synonyms: ["Chromic chloride", "Chromium trichloride"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Tanning, mordant, catalyst. Cr(III) is MUCH less toxic than Cr(VI). Purple/green crystals." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers (may form Cr(VI))"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Chromium(III) chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

// ===== AGRICULTURAL CHEMICALS =====

chemicalHazardDB["Copper Hydroxide"] = {
  cas: "20427-59-2", formula: "Cu(OH)₂",
  de: "Kupferhydroxid", es: "Hidróxido de cobre", fr: "Hydroxyde de cuivre", pt: "Hidróxido de cobre",
  synonyms: ["Cupric hydroxide", "Kocide"],
  classes: ["irritant", "environmental"],
  ghs: ["GHS07", "GHS09"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "Dust mask" }, other: "Fungicide/bactericide for plants. Blue powder. Organic farming approved." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Acids", "Reducing agents"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Copper hydroxide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Sodium Tetraborate Decahydrate"] = {
  cas: "1303-96-4", formula: "Na₂B₄O₇·10H₂O",
  de: "Natriumtetraborat-Decahydrat", es: "Tetraborato de sodio decahidratado", fr: "Tétraborate de sodium décahydraté", pt: "Tetraborato de sódio deca-hidratado",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Cleaning, flux, buffer, slime activator. REPRODUCTIVE TOXIN. EU restricted in consumer products." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Borax" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth. Medical attention." }
};

chemicalHazardDB["Glycine"] = {
  cas: "56-40-6", formula: "C₂H₅NO₂",
  de: "Glycin", es: "Glicina", fr: "Glycine", pt: "Glicina",
  synonyms: ["Aminoacetic acid", "Gly"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Simplest amino acid. Buffer, food additive, supplement. Non-toxic." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Glycine" },
...
chemicalHazardDB["Sodium Thiosulfate Pentahydrate"] = {
  ...
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Photography fixer, dechlorination, cyanide antidote, aquarium water treatment." },
...
chemicalHazardDB["Sodium Carbonate Anhydrous"] = {
  cas: "497-19-8", formula: "Na₂CO₃",
  de: "Natriumcarbonat wasserfrei", es: "Carbonato de sodio anhidro", fr: "Carbonate de sodium anhydre", pt: "Carbonato de sódio anidro",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Gloves for prolonged contact" }, respiratory: { required: false, type: "Dust mask" }, other: "Glass making, water softening, cleaning, pH adjustment." },
...
chemicalHazardDB["Aluminum Sulfate"] = {
  cas: "10043-01-3", formula: "Al₂(SO₄)₃",
  de: "Aluminiumsulfat", es: "Sulfato de aluminio", fr: "Sulfate d'aluminium", pt: "Sulfato de alumínio",
  synonyms: ["Alum", "Papermaker's alum", "Filter alum"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H318", text: "Causes serious eye damage" }
  ],
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Water treatment (flocculation), paper sizing, mordant." },
...
chemicalHazardDB["Polyaluminum Chloride"] = {
  cas: "1327-41-9", formula: "Al₂Cl(OH)₅",
  de: "Polyaluminiumchlorid", es: "Policloruro de aluminio", fr: "Polychlorure d'aluminium", pt: "Policloreto de alumínio",
  synonyms: ["PAC", "Poly aluminium chloride"],
  classes: ["corrosive"],
  ghs: ["GHS05"],
  hazardStatements: [
    { code: "H290", text: "May be corrosive to metals" },
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "Ventilation" }, other: "Superior coagulant for water treatment. Works in wider pH range than alum." },
  storage: { cabinet: "Corrosive storage", temp: "Above 0°C (freezing damages)", ventilation: "Normal", incompatible: ["Strong bases", "Metals"] },
  transport: { un: "1760", class: "8", packingGroup: "III", properShipping: "Corrosive liquid" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 20 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth. Do NOT vomit." }
};

chemicalHazardDB["Sodium Hypochlorite 12%"] = {
  cas: "7681-52-9", formula: "NaOCl",
  de: "Natriumhypochlorit 12%", es: "Hipoclorito de sodio 12%", fr: "Hypochlorite de sodium 12%", pt: "Hipoclorito de sódio 12%",
  synonyms: ["Bleach (industrial)", "Liquid chlorine", "Hypo"],
  classes: ["corrosive", "oxidizer", "environmental"],
  ghs: ["GHS03", "GHS05", "GHS09"],
  hazardStatements: [
    { code: "H272", text: "May intensify fire; oxidizer" },
    { code: "H314", text: "Causes severe skin burns and eye damage" },
    { code: "H400", text: "Very toxic to aquatic life" },
    { code: "EUH031", text: "Contact with acids liberates toxic gas (Cl₂)" }
  ],
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "PVC or rubber gloves, apron" }, respiratory: { required: true, type: "Chlorine-rated respirator" }, other: "Industrial strength bleach. NEVER MIX WITH ACIDS or ammonia products!" },
  storage: { cabinet: "Oxidizer storage (away from acids!)", temp: "Cool, below 25°C", ventilation: "Excellent", incompatible: ["Acids (releases Cl2)", "Ammonia", "Reducing agents", "Organics"] },
  transport: { un: "1791", class: "8", packingGroup: "II", properShipping: "Hypochlorite solution" },
...
chemicalHazardDB["Dibutyl Phthalate"] = {
  cas: "84-74-2", formula: "C₁₆H₂₂O₄",
  de: "Dibutylphthalat", es: "Ftalato de dibutilo", fr: "Phtalate de dibutyle", pt: "Ftalato de dibutila",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Nitrile gloves" }, respiratory: { required: false, type: "Ventilation" }, other: "Plasticizer. REPRODUCTIVE TOXIN. Restricted under REACH. Being phased out." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers", "Strong acids"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Dibutyl phthalate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Triphenyl Phosphate"] = {
  cas: "115-86-6", formula: "C₁₈H₁₅O₄P",
  de: "Triphenylphosphat", es: "Fosfato de trifenilo", fr: "Phosphate de triphényle", pt: "Fosfato de trifenila",
  synonyms: ["TPP", "Triphenyl phosphate"],
  classes: ["irritant", "environmental"],
  ghs: ["GHS07", "GHS09"],
  hazardStatements: [
    { code: "H411", text: "Toxic to aquatic life with long lasting effects" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Flame retardant, plasticizer. Replacing phthalates in some applications." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
...
chemicalHazardDB["Carbon Dioxide (Liquid)"] = {
  cas: "124-38-9", formula: "CO₂",
  de: "Kohlendioxid (flüssig)", es: "Dióxido de carbono (líquido)", fr: "Dioxyde de carbone (liquide)", pt: "Dióxido de carbono (líquido)",
  synonyms: ["LCO2", "Carbonic acid gas", "Dry ice (solid)"],
  classes: ["compressed"],
  ghs: ["GHS04"],
  hazardStatements: [
    { code: "H280", text: "Contains gas under pressure; may explode if heated" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Cryogenic gloves" }, respiratory: { required: true, type: "SCBA in confined spaces" }, other: "ASPHYXIANT in confined spaces. Cryogenic liquid causes frostbite. Displaces oxygen silently." },
  storage: { cabinet: "Cylinder storage (ventilated)", temp: "Below 52°C", ventilation: "Excellent", incompatible: ["Confined spaces without ventilation"] },
  transport: { un: "2187", class: "2.2", packingGroup: "N/A", properShipping: "Carbon dioxide, refrigerated liquid" },
  firstAid: { inhalation: "Move to fresh air. CPR if needed. Medical attention.", skin: "Warm slowly (frostbite). Medical attention.", eyes: "Flush. Medical attention.", ingestion: "N/A" }
};

chemicalHazardDB["Nitrogen (Liquid)"] = {
  cas: "7727-37-9", formula: "N₂",
  de: "Stickstoff (flüssig)", es: "Nitrógeno (líquido)", fr: "Azote (liquide)", pt: "Nitrogênio (líquido)",
  synonyms: ["LN2", "Liquid nitrogen", "Cryogenic nitrogen"],
  classes: ["compressed"],
  ghs: ["GHS04"],
  hazardStatements: [
    { code: "H281", text: "Contains refrigerated gas; may cause cryogenic burns or injury" }
  ],
  ppe: { eyes: { required: true, type: "Face shield + safety glasses" }, skin: { required: true, type: "Cryogenic gloves, long sleeves" }, respiratory: { required: true, type: "SCBA in confined spaces" }, other: "-196°C! ASPHYXIANT - displaces oxygen. 1L liquid = 694L gas. Use only in ventilated areas." },
  storage: { cabinet: "Cryogenic dewar", temp: "Cryogenic", ventilation: "Excellent", incompatible: ["Confined spaces", "Incompatible materials that become brittle"] },
  transport: { un: "1977", class: "2.2", packingGroup: "N/A", properShipping: "Nitrogen, refrigerated liquid" },
  firstAid: { inhalation: "Fresh air. CPR if not breathing.", skin: "Warm gradually (frostbite). Medical attention.", eyes: "Flush. Medical attention.", ingestion: "N/A" }
};

chemicalHazardDB["Argon (Liquid)"] = {
  cas: "7440-37-1", formula: "Ar",
  de: "Argon (flüssig)", es: "Argón (líquido)", fr: "Argon (liquide)", pt: "Argônio (líquido)",
  synonyms: ["LAr", "Liquid argon"],
  classes: ["compressed"],
  ghs: ["GHS04"],
  hazardStatements: [
    { code: "H281", text: "Contains refrigerated gas; may cause cryogenic burns or injury" }
  ],
  ppe: { eyes: { required: true, type: "Face shield + safety glasses" }, skin: { required: true, type: "Cryogenic gloves" }, respiratory: { required: true, type: "SCBA in confined spaces" }, other: "-186°C! ASPHYXIANT. Used for welding shield gas, cryopreservation. Heavier than air." },
  storage: { cabinet: "Cryogenic dewar", temp: "Cryogenic", ventilation: "Excellent", incompatible: ["Confined spaces"] },
  transport: { un: "1951", class: "2.2", packingGroup: "N/A", properShipping: "Argon, refrigerated liquid" },
  firstAid: { inhalation: "Fresh air. CPR if needed.", skin: "Warm gradually.", eyes: "Flush.", ingestion: "N/A" }
};
...
chemicalHazardDB["Chromium(III) Sulfate"] = {
  ...
  synonyms: ["Chromic sulfate", "Chrome alum"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Leather tanning (chrome tanning). Cr(III) is much safer than Cr(VI). Green color." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers (may form Cr(VI))", "Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Chromium(III) sulfate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Silica (Crystalline)"] = {
  ...
  de: "Siliciumdioxid (kristallin)", es: "Sílice (cristalina)", fr: "Silice (cristalline)", pt: "Sílica (cristalina)",
  synonyms: ["Quartz", "Cristobalite", "Tridymite"],
  classes: ["health"],
  ghs: ["GHS08"],
  hazardStatements: [
    { code: "H350", text: "May cause cancer (inhalation)" },
    { code: "H372", text: "Causes damage to lungs through prolonged exposure" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: true, type: "P3 particulate respirator" }, other: "CARCINOGEN (silicosis). Common in sand, concrete, stone. Strict exposure limits." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Hydrofluoric acid"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Silica" },
  firstAid: { inhalation: "Fresh air. Medical attention.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Asbestos (Chrysotile)"] = {
  cas: "12001-29-5", formula: "Mg₃Si₂O₅(OH)₄",
  de: "Asbest (Chrysotil)", es: "Asbesto (crisotilo)", fr: "Amiante (chrysotile)", pt: "Amianto (crisotila)",
  synonyms: ["White asbestos", "Serpentine asbestos"],
  classes: ["health"],
  ghs: ["GHS08"],
  hazardStatements: [
    { code: "H350", text: "May cause cancer" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Disposable coveralls" }, respiratory: { required: true, type: "P3 respirator or powered air" }, other: "KNOWN CARCINOGEN. Banned in EU. Causes mesothelioma, lung cancer, asbestosis. Licensed removal only." },
...
chemicalHazardDB["Graphite"] = {
  cas: "7782-42-5", formula: "C",
  de: "Graphit", es: "Grafito", fr: "Graphite", pt: "Grafite",
  synonyms: ["Plumbago", "Black lead"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Lubricant, pencils, batteries, electrodes. Generally safe. Conductive." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers", "Fluorine"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Graphite" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Mineral Oil"] = {
  cas: "8012-95-1", formula: "Mixture",
  de: "Mineralöl", es: "Aceite mineral", fr: "Huile minérale", pt: "Óleo mineral",
  synonyms: ["Paraffin oil", "White oil", "Liquid paraffin"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional for brief contact" }, respiratory: { required: false, type: "Ventilation for mist" }, other: "Food-grade available. Laxative, cosmetics, transformer oil. Refined grades are safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Mineral oil" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe (food-grade is a laxative)." }
};

chemicalHazardDB["Polyethylene Glycol"] = {
  cas: "25322-68-3", formula: "(C₂H₄O)ₙH₂O",
  de: "Polyethylenglykol", es: "Polietilenglicol", fr: "Polyéthylène glycol", pt: "Polietilenoglicol",
  synonyms: ["PEG", "Macrogol", "Carbowax"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Pharmaceutical excipient, cosmetics, laxative. Very safe. MW from 200-8000+." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Polyethylene glycol" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};
...
chemicalHazardDB["Diethylene Glycol"] = {
  ...
  synonyms: ["DEG", "Diglycol"],
  classes: ["toxic"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Gloves" }, respiratory: { required: false, type: "Ventilation" }, other: "Solvent, plasticizer. TOXIC - caused mass poisonings when used as food/medicine adulterant." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Diethylene glycol" },
...
chemicalHazardDB["Sorbitol"] = {
  ...
  synonyms: ["D-Glucitol", "E420", "Sugar alcohol"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Sugar substitute, humectant, laxative. Diabetic-friendly. Safe. May cause GI upset in excess." },
  storage: { cabinet: "General storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: [] },
...
chemicalHazardDB["Acetic Acid (Glacial)"] = {
  cas: "64-19-7", formula: "CH₃COOH",
  de: "Essigsäure (Eisessig)", es: "Ácido acético (glacial)", fr: "Acide acétique (glacial)", pt: "Ácido acético (glacial)",
  synonyms: ["Glacial acetic", "Ethanoic acid", "Vinegar (dilute)"],
  classes: ["flammable", "corrosive"],
  ghs: ["GHS02", "GHS05"],
  hazardStatements: [
    { code: "H226", text: "Flammable liquid and vapor" },
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles + face shield" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: true, type: "Acid vapor respirator" }, other: "Glacial = >99% concentration. Pungent vinegar smell. Freezes at 16.6°C." },
...
chemicalHazardDB["Maleic Acid"] = {
  cas: "110-16-7", formula: "C₄H₄O₄",
  de: "Maleinsäure", es: "Ácido maleico", fr: "Acide maléique", pt: "Ácido maleico",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Polymer intermediate, food acidulant (E296). Used to make fumaric acid." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases", "Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Maleic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Fumaric Acid"] = {
  cas: "110-17-8", formula: "C₄H₄O₄",
  de: "Fumarsäure", es: "Ácido fumárico", fr: "Acide fumarique", pt: "Ácido fumárico",
  synonyms: ["trans-Butenedioic acid", "E297"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Food additive (E297), beverages, baking powder. Natural metabolite. Generally safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Fumaric acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Adipic Acid"] = {
  cas: "124-04-9", formula: "C₆H₁₀O₄",
  de: "Adipinsäure", es: "Ácido adípico", fr: "Acide adipique", pt: "Ácido adípico",
  synonyms: ["Hexanedioic acid", "E355"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H319", text: "Causes serious eye irritation" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Nylon 6,6 precursor. Food additive (E355). Global production: 2.5M tonnes/year." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers", "Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Adipic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Benzoic Acid"] = {
  cas: "65-85-0", formula: "C₇H₆O₂",
  de: "Benzoesäure", es: "Ácido benzoico", fr: "Acide benzoïque", pt: "Ácido benzoico",
  synonyms: ["Benzenecarboxylic acid", "E210"],
  classes: ["irritant", "health"],
  ghs: ["GHS05", "GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
    { code: "H318", text: "Causes serious eye damage" },
    { code: "H372", text: "May cause damage to organs through prolonged exposure" }
  ],
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "Dust mask" }, other: "Food preservative (E210), precursor to benzoyl chloride. Sublimes at 100°C." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers", "Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Benzoic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Stearic Acid"] = {
  cas: "57-11-4", formula: "C₁₈H₃₆O₂",
  de: "Stearinsäure", es: "Ácido esteárico", fr: "Acide stéarique", pt: "Ácido esteárico",
  synonyms: ["Octadecanoic acid", "E570"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Soap making, candles, cosmetics, lubricant. Waxy solid. Food-grade available (E570)." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Stearic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Oleic Acid"] = {
  cas: "112-80-1", formula: "C₁₈H₃₄O₂",
  de: "Ölsäure", es: "Ácido oleico", fr: "Acide oléique", pt: "Ácido oleico",
  synonyms: ["cis-9-Octadecenoic acid", "Omega-9"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" }
  ],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Main fatty acid in olive oil. Soap making, cosmetics, lubricant. Oily liquid." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Oleic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Palmitic Acid"] = {
  cas: "57-10-3", formula: "C₁₆H₃₂O₂",
  de: "Palmitinsäure", es: "Ácido palmítico", fr: "Acide palmitique", pt: "Ácido palmítico",
  synonyms: ["Hexadecanoic acid", "Cetylic acid"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Most common saturated fatty acid. Soap, cosmetics. Named after palm oil." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Palmitic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Lauric Acid"] = {
  cas: "143-07-7", formula: "C₁₂H₂₄O₂",
  de: "Laurinsäure", es: "Ácido láurico", fr: "Acide laurique", pt: "Ácido láurico",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Major component of coconut oil. Soap making, cosmetics. Antimicrobial properties." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Lauric acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Safe." }
};
...
chemicalHazardDB["Buffered Oxide Etch"] = {
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Neoprene gloves, apron" }, respiratory: { required: true, type: "HF-rated respirator" }, other: "Contains HF. Same precautions as hydrofluoric acid. Used in semiconductor wafer processing." },
  storage: { cabinet: "Dedicated HF cabinet (polyethylene)", temp: "Room temperature", ventilation: "Excellent", incompatible: ["Glass", "Metals", "Silica-based materials"] },
  transport: { un: "1790", class: "8 (6.1)", packingGroup: "II", properShipping: "Hydrofluoric acid solution" },
  firstAid: { inhalation: "Fresh air. Medical attention.", skin: "Flush, apply calcium gluconate. Medical attention.", eyes: "Flush 30 min. Medical attention.", ingestion: "Give calcium. Medical attention." }
};

chemicalHazardDB["Piranha Solution"] = {
  cas: "Mixture", formula: "H₂SO₄/H₂O₂",
  de: "Piranha-Lösung", es: "Solución piraña", fr: "Solution piranha", pt: "Solução piranha",
  synonyms: ["Piranha etch", "Sulfuric peroxide mix", "SPM"],
  classes: ["corrosive", "oxidizer"],
  ghs: ["GHS03", "GHS05"],
  hazardStatements: [
    { code: "H271", text: "May cause fire or explosion; strong oxidizer" },
    { code: "H314", text: "Causes severe skin burns and eye damage" }
  ],
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Acid-resistant gloves and apron" }, respiratory: { required: true, type: "Acid vapor respirator" }, other: "EXTREMELY REACTIVE. Mix slowly (acid to peroxide). Exothermic - gets very hot. Violently attacks organics. Used to clean semiconductor wafers." },
  storage: { cabinet: "Never store mixed!", temp: "N/A", ventilation: "N/A", incompatible: ["Everything organic", "Metals", "Store components separately"] },
  transport: { un: "Do not transport mixed", class: "N/A", packingGroup: "N/A", properShipping: "Do not ship mixed solution" },
...
chemicalHazardDB["Paraquat"] = {
  ...
  de: "Paraquat", es: "Paraquat", fr: "Paraquat", pt: "Paraquate",
  synonyms: ["Gramoxone", "Methyl viologen dichloride"],
  classes: ["toxic", "environmental"],
  ghs: ["GHS06", "GHS08", "GHS09"],
  hazardStatements: [
    { code: "H301", text: "Toxic if swallowed" },
    ...
    { code: "H319", text: "Causes serious eye irritation" },
    { code: "H330", text: "Fatal if inhaled" },
    { code: "H372", text: "Causes damage to organs (lungs)" },
    { code: "H400", text: "Very toxic to aquatic life" }
  ],
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Full chemical suit" }, respiratory: { required: true, type: "Full-face respirator" }, other: "EXTREMELY TOXIC herbicide. NO ANTIDOTE. Causes progressive lung fibrosis. Banned in EU. One swallow can be fatal." },
  storage: { cabinet: "Locked pesticide storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases", "Reducing agents"] },
  transport: { un: "2781", class: "6.1", packingGroup: "II", properShipping: "Bipyridilium pesticide" },
  firstAid: { inhalation: "Fresh air. IMMEDIATE medical attention.", skin: "Remove clothing, wash thoroughly.", eyes: "Flush 30 min.", ingestion: "Give Fuller's earth or activated charcoal. IMMEDIATE medical attention. NO ANTIDOTE." }
};
...
chemicalHazardDB["R-32"] = {
  ...
  de: "R-32", es: "R-32", fr: "R-32", pt: "R-32",
  synonyms: ["Difluoromethane", "HFC-32"],
  classes: ["flammable", "compressed"],
  ghs: ["GHS02", "GHS04"],
  hazardStatements: [
    { code: "H220", text: "Extremely flammable gas" },
    { code: "H280", text: "Contains gas under pressure" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Insulated gloves" }, respiratory: { required: true, type: "SCBA in confined spaces" }, other: "Lower GWP refrigerant (675). MILDLY FLAMMABLE (A2L class). Newer A/C systems. Requires trained technicians." },
  storage: { cabinet: "Cylinder storage (away from ignition)", temp: "Below 52°C", ventilation: "Well-ventilated", incompatible: ["Ignition sources", "Oxidizers"] },
  transport: { un: "3252", class: "2.1", packingGroup: "N/A", properShipping: "Difluoromethane" },
...
chemicalHazardDB["Potassium Ferricyanide"] = {
  ...
  de: "Kaliumhexacyanoferrat(III)", es: "Ferricianuro de potasio", fr: "Ferricyanure de potassium", pt: "Ferricianeto de potássio",
  synonyms: ["Potassium hexacyanoferrate(III)", "Red prussiate of potash"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Photography (bleach), blueprints, wine fining. Despite 'cyanide' in name, it's relatively safe - cyanide is tightly bound. DO NOT mix with acids!" },
...
chemicalHazardDB["Chlorine Dioxide"] = {
  cas: "10049-04-4", formula: "ClO₂",
  de: "Chlordioxid", es: "Dióxido de cloro", fr: "Dioxyde de chlore", pt: "Dióxido de cloro",
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Full chemical suit" }, respiratory: { required: true, type: "SCBA" }, other: "Paper/pulp bleaching (ECF process), water treatment. Generated on-site - cannot be stored. Explosive at high concentrations." },
  storage: { cabinet: "Generated on demand - do not store", temp: "N/A", ventilation: "N/A", incompatible: ["Cannot be stored in concentration >10%"] },
  transport: { un: "Do not transport (generate on-site)", class: "N/A", packingGroup: "N/A", properShipping: "Generated on-site only" },
  firstAid: { inhalation: "Fresh air. CPR. IMMEDIATE medical attention.", skin: "Remove clothing, flush 30 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth. Medical attention." }
};

chemicalHazardDB["Hydrogen Peroxide 50%"] = {
  cas: "7722-84-1", formula: "H₂O₂",
  de: "Wasserstoffperoxid 50%", es: "Peróxido de hidrógeno 50%", fr: "Peroxyde d'hydrogène 50%", pt: "Peróxido de hidrogênio 50%",
  synonyms: ["High-strength peroxide", "HTP"],
  classes: ["oxidizer", "corrosive"],
  ghs: ["GHS03", "GHS05", "GHS07"],
  hazardStatements: [
    { code: "H271", text: "May cause fire or explosion; strong oxidizer" },
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "PVC or PE gloves and apron" }, respiratory: { required: true, type: "Vapor respirator" }, other: "Industrial strength. STRONG OXIDIZER - can ignite organics. Paper bleaching, textile, rocket propellant. Keep away from metals (catalyze decomposition)." },
  storage: { cabinet: "Oxidizer storage (vented)", temp: "Cool (<25°C)", ventilation: "Excellent", incompatible: ["Organics", "Metals", "Reducing agents", "Alkalis"] },
  transport: { un: "2014", class: "5.1 (8)", packingGroup: "II", properShipping: "Hydrogen peroxide, aqueous solution" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 30 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Do NOT vomit. Medical attention." }
};

chemicalHazardDB["Tall Oil"] = {
  cas: "8002-26-4", formula: "Mixture",
  de: "Tallöl", es: "Aceite de resina", fr: "Tallol", pt: "Óleo de resina",
  synonyms: ["Liquid rosin", "Tallol"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Gloves" }, respiratory: { required: false, type: "Ventilation" }, other: "Pulp mill byproduct. Used in soaps, lubricants, coatings. Mixture of fatty acids and rosin acids." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Tall oil" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Cetyl Alcohol"] = {
  cas: "36653-82-4", formula: "C₁₆H₃₄O",
  de: "Cetylalkohol", es: "Alcohol cetílico", fr: "Alcool cétylique", pt: "Álcool cetílico",
  synonyms: ["1-Hexadecanol", "Palmityl alcohol", "Cetanol"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Emollient, emulsifier in lotions and creams. Waxy solid. Very safe for skin contact." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Cetyl alcohol" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Dimethicone"] = {
  cas: "9006-65-9", formula: "(C₂H₆OSi)ₙ",
  de: "Dimethicon", es: "Dimeticona", fr: "Diméthicone", pt: "Dimeticona",
  synonyms: ["Polydimethylsiloxane", "PDMS", "Silicone oil"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Silicone. Hair conditioners, skin care, lubricant. Very safe. Also used as antifoaming agent." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Dimethicone" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};
...
chemicalHazardDB["Phenolphthalein"] = {
  cas: "77-09-8", formula: "C₂₀H₁₄O₄",
  de: "Phenolphthalein", es: "Fenolftaleína", fr: "Phénolphtaléine", pt: "Fenolftaleína",
  synonyms: ["3,3-Bis(4-hydroxyphenyl)phthalide"],
  classes: ["health"],
  ghs: ["GHS08"],
  hazardStatements: [
    { code: "H341", text: "Suspected of causing genetic defects" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "pH indicator (colorless→pink at pH 8.2-10). Formerly used as laxative - banned due to carcinogenicity concerns." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Phenolphthalein" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Bromothymol Blue"] = {
  cas: "76-59-5", formula: "C₂₇H₂₈Br₂O₅S",
  de: "Bromthymolblau", es: "Azul de bromotimol", fr: "Bleu de bromothymol", pt: "Azul de bromotimol",
  synonyms: ["BTB", "Dibromothymolsulfonphthalein"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "pH indicator (yellow→blue at pH 6.0-7.6). Aquarium testing, biology labs. Stains." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Bromothymol blue" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Methyl Orange"] = {
  cas: "547-58-0", formula: "C₁₄H₁₄N₃NaO₃S",
  de: "Methylorange", es: "Naranja de metilo", fr: "Méthylorange", pt: "Alaranjado de metila",
  synonyms: ["Helianthine", "Gold orange"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Gloves (stains)" }, respiratory: { required: false, type: "N/A" }, other: "pH indicator (red→yellow at pH 3.1-4.4). Acid-base titrations. Azo dye - stains everything." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Methyl orange" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Universal Indicator"] = {
  cas: "Mixture", formula: "Various",
  de: "Universalindikator", es: "Indicador universal", fr: "Indicateur universel", pt: "Indicador universal",
  synonyms: ["Full-range indicator"],
  classes: ["flammable"],
  ghs: ["GHS02"],
  hazardStatements: [
    { code: "H225", text: "Highly flammable liquid and vapor" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Ventilation" }, other: "Mixture of pH indicators in ethanol. Shows full pH range by color. Flammable due to alcohol solvent." },
  storage: { cabinet: "Flammable cabinet", temp: "Room temperature", ventilation: "Normal", incompatible: ["Ignition sources"] },
  transport: { un: "1170", class: "3", packingGroup: "II", properShipping: "Ethanol solution" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Benedict's Solution"] = {
  cas: "Mixture", formula: "CuSO₄/Na₂CO₃/Citrate",
  de: "Benedict-Lösung", es: "Solución de Benedict", fr: "Solution de Benedict", pt: "Solução de Benedict",
  synonyms: ["Benedict's reagent"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Tests for reducing sugars (glucose). Blue→green→yellow→orange→red with increasing sugar. Biology labs." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Benedict's solution" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Fehling's Solution"] = {
  cas: "Mixture", formula: "CuSO₄/NaOH/Tartrate",
  de: "Fehling-Lösung", es: "Solución de Fehling", fr: "Solution de Fehling", pt: "Solução de Fehling",
  synonyms: ["Fehling's reagent"],
  classes: ["corrosive"],
  ghs: ["GHS05"],
  hazardStatements: [
    { code: "H314", text: "Causes severe skin burns and eye damage" }
  ],
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "N/A" }, other: "Tests for aldehydes and reducing sugars. Two solutions mixed before use. Contains NaOH - corrosive." },
  storage: { cabinet: "Corrosive cabinet (Solution B)", temp: "Room temperature", ventilation: "Normal", incompatible: ["Acids"] },
  transport: { un: "1824", class: "8", packingGroup: "II", properShipping: "Sodium hydroxide solution" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 20 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth. Do NOT vomit." }
};

chemicalHazardDB["Lugol's Iodine"] = {
  cas: "Mixture", formula: "I₂/KI",
  de: "Lugol-Lösung", es: "Lugol", fr: "Solution de Lugol", pt: "Solução de Lugol",
  synonyms: ["Lugol's solution", "Iodine-potassium iodide"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Starch test (blue-black color), antiseptic, thyroid treatment. STAINS everything brown. Contains 5% iodine typically." },
  storage: { cabinet: "General storage (dark bottle)", temp: "Room temperature", ventilation: "Normal", incompatible: ["Ammonia", "Strong reducing agents"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Iodine solution" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Give starch water, then medical attention." }
};

chemicalHazardDB["Biuret Reagent"] = {
  cas: "Mixture", formula: "CuSO₄/NaOH",
  de: "Biuret-Reagenz", es: "Reactivo de Biuret", fr: "Réactif de Biuret", pt: "Reagente de Biureto",
  synonyms: ["Biuret solution", "Protein test reagent"],
  classes: ["corrosive"],
  ghs: ["GHS05"],
  hazardStatements: [
    { code: "H314", text: "Causes severe skin burns and eye damage" }
  ],
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "N/A" }, other: "Tests for proteins (purple color with peptide bonds). Contains strong NaOH - caustic." },
  storage: { cabinet: "Corrosive cabinet", temp: "Room temperature", ventilation: "Normal", incompatible: ["Acids"] },
  transport: { un: "1824", class: "8", packingGroup: "II", properShipping: "Sodium hydroxide solution" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 20 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth. Do NOT vomit." }
};
...
chemicalHazardDB["Safranin O"] = {
  ...
  de: "Safranin O", es: "Safranina O", fr: "Safranine O", pt: "Safranina O",
  synonyms: ["Basic Red 2", "Safranin Y"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Counterstain in Gram staining. Red/pink color. Cartilage staining in histology." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Safranin O" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Hematoxylin"] = {
  ...
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Gloves (stains)" }, respiratory: { required: false, type: "N/A" }, other: "Natural dye from logwood. H&E staining - stains nuclei blue/purple. Requires mordant (aluminum salts)." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Hematoxylin" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Monomethylhydrazine"] = {
  ...
  de: "Monomethylhydrazin", es: "Monometilhidrazina", fr: "Monométhylhydrazine", pt: "Monometil-hidrazina",
  synonyms: ["MMH", "Methylhydrazine"],
  classes: ["flammable", "toxic", "corrosive", "health"],
  ghs: ["GHS02", "GHS05", "GHS06", "GHS08"],
  hazardStatements: [
    { code: "H225", text: "Highly flammable liquid and vapor" },
    { code: "H301", text: "Toxic if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Full face shield" }, skin: { required: true, type: "Full chemical suit" }, respiratory: { required: true, type: "SCBA" }, other: "KNOWN CARCINOGEN. Spacecraft propellant (with N2O4). HYPERGOLIC - ignites on contact with oxidizers." },
  storage: { cabinet: "Dedicated isolated storage", temp: "Cool", ventilation: "Excellent", incompatible: ["Oxidizers (hypergolic!)", "Acids", "All ignition sources"] },
  transport: { un: "1244", class: "6.1 (3, 8)", packingGroup: "I", properShipping: "Methylhydrazine" },
  firstAid: { inhalation: "Fresh air. IMMEDIATE medical attention.", skin: "Remove clothing, flush 30 min.", eyes: "Flush 30 min.", ingestion: "IMMEDIATE medical attention." }
};

chemicalHazardDB["Nitrogen Tetroxide"] = {
  cas: "10544-72-6", formula: "N₂O₄",
  de: "Distickstofftetroxid", es: "Tetróxido de nitrógeno", fr: "Tétroxyde d'azote", pt: "Tetróxido de nitrogênio",
  synonyms: ["NTO", "Dinitrogen tetroxide"],
  classes: ["oxidizer", "toxic", "corrosive"],
  ghs: ["GHS03", "GHS05", "GHS06"],
  hazardStatements: [
    { code: "H270", text: "May cause or intensify fire; oxidizer" },
  ...
  ppe: { eyes: { required: true, type: "Full face shield" }, skin: { required: true, type: "Full chemical suit" }, respiratory: { required: true, type: "SCBA" }, other: "Rocket oxidizer. HYPERGOLIC with hydrazines. Dissociates to brown NO2 gas. Pulmonary edema hazard." },
  storage: { cabinet: "Pressurized oxidizer storage (isolated)", temp: "Cool", ventilation: "Excellent", incompatible: ["Fuels (hypergolic)", "Reducing agents", "Organics"] },
  transport: { un: "1067", class: "2.3 (5.1, 8)", packingGroup: "N/A", properShipping: "Dinitrogen tetroxide" },
  firstAid: { inhalation: "Fresh air. IMMEDIATE medical attention (delayed pulmonary edema).", skin: "Remove clothing, flush.", eyes: "Flush 30 min.", ingestion: "N/A (gas)" }
};
...
chemicalHazardDB["Potassium Perchlorate"] = {
  ...
  synonyms: ["KP", "Potassium chlorate(VII)"],
  classes: ["oxidizer"],
  ghs: ["GHS03"],
  hazardStatements: [
    { code: "H271", text: "May cause fire or explosion; strong oxidizer" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Fireworks, pyrotechnics, solid rocket propellant. STRONG OXIDIZER - mixtures with fuels can explode from friction/impact." },
  storage: { cabinet: "Oxidizer storage (isolated)", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Sulfur", "Metals", "Organics", "Friction/impact"] },
  transport: { un: "1489", class: "5.1", packingGroup: "II", properShipping: "Potassium perchlorate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Nitrocellulose"] = {
  cas: "9004-70-0", formula: "(C₆H₇N₃O₁₁)ₙ",
  de: "Nitrocellulose", es: "Nitrocelulosa", fr: "Nitrocellulose", pt: "Nitrocelulose",
  synonyms: ["Guncotton", "Cellulose nitrate", "Flash paper"],
  classes: ["flammable", "explosive"],
  ghs: ["GHS02"],
  hazardStatements: [
    { code: "H228", text: "Flammable solid" },
    { code: "H241", text: "Heating may cause fire or explosion" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Propellant, lacquers, film (old). MUST BE KEPT WET (>25% water/alcohol) - dry nitrocellulose is explosive. Self-ignites if stored improperly." },
  storage: { cabinet: "Wet storage (never let dry!)", temp: "Cool", ventilation: "Normal", incompatible: ["Heat", "Drying out", "Oxidizers"] },
  transport: { un: "2556", class: "4.1", packingGroup: "I", properShipping: "Nitrocellulose, wetted" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Oxygen (Compressed)"] = {
  ...
  synonyms: ["GOX", "Gaseous oxygen"],
  classes: ["oxidizer", "compressed"],
  ghs: ["GHS03", "GHS04"],
  hazardStatements: [
    { code: "H270", text: "May cause or intensify fire; oxidizer" },
    { code: "H280", text: "Contains gas under pressure" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Welding, medical, industrial. NEVER use with oil/grease - can ignite spontaneously. Enriched O2 makes everything more flammable." },
...
chemicalHazardDB["MAPP Gas"] = {
  cas: "Mixture", formula: "C₃H₄/C₃H₈",
  de: "MAPP-Gas", es: "Gas MAPP", fr: "Gaz MAPP", pt: "Gás MAPP",
  synonyms: ["Methylacetylene-propadiene", "MAP-Pro"],
  classes: ["flammable"],
  ghs: ["GHS02", "GHS04"],
  hazardStatements: [
    { code: "H220", text: "Extremely flammable gas" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Insulated gloves" }, respiratory: { required: true, type: "SCBA in confined spaces" }, other: "Hotter than propane, safer than acetylene. Brazing, soldering. Original MAPP discontinued - now 'MAP-Pro' substitute." },
  storage: { cabinet: "Cylinder storage", temp: "Below 52°C", ventilation: "Well-ventilated", incompatible: ["Oxidizers", "Ignition sources"] },
  transport: { un: "1060", class: "2.1", packingGroup: "N/A", properShipping: "Methylacetylene-propadiene mixture" },
  firstAid: { inhalation: "Fresh air.", skin: "Warm gradually.", eyes: "N/A", ingestion: "N/A" }
};

// ===== NUCLEAR/RADIOACTIVE (non-radioactive forms) =====

chemicalHazardDB["Uranyl Nitrate"] = {
  cas: "10102-06-4", formula: "UO₂(NO₃)₂",
  de: "Uranylnitrat", es: "Nitrato de uranilo", fr: "Nitrate d'uranyle", pt: "Nitrato de uranila",
  synonyms: ["Uranium(VI) nitrate", "Yellow salt"],
  classes: ["toxic", "oxidizer", "health", "environmental"],
  ghs: ["GHS03", "GHS06", "GHS08", "GHS09"],
  hazardStatements: [
    { code: "H272", text: "May intensify fire; oxidizer" },
    { code: "H300", text: "Fatal if swallowed" },
    { code: "H330", text: "Fatal if inhaled" },
    { code: "H373", text: "May cause damage to kidneys" },
    { code: "H411", text: "Toxic to aquatic life" }
  ],
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Full protection" }, respiratory: { required: true, type: "Full-face respirator" }, other: "CHEMICALLY TOXIC (heavy metal) + RADIOACTIVE. Depleted U still hazardous. Nuclear industry, luminous paints (historical)." },
  storage: { cabinet: "Locked radioactive storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Organics"] },
  transport: { un: "2981", class: "6.1 (7)", packingGroup: "II", properShipping: "Uranyl nitrate, solid" },
  firstAid: { inhalation: "Fresh air. Medical attention.", skin: "Wash thoroughly.", eyes: "Flush 15 min.", ingestion: "Medical attention. Chelation may be needed." }
};

chemicalHazardDB["Thorium Nitrate"] = {
  cas: "13823-29-5", formula: "Th(NO₃)₄",
  de: "Thoriumnitrat", es: "Nitrato de torio", fr: "Nitrate de thorium", pt: "Nitrato de tório",
  synonyms: ["Thorium(IV) nitrate"],
  classes: ["oxidizer", "irritant"],
  ghs: ["GHS03", "GHS07"],
  hazardStatements: [
    { code: "H272", text: "May intensify fire; oxidizer" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "Particulate respirator" }, other: "RADIOACTIVE (alpha emitter). Gas mantle production (historical). Chemically less toxic than uranium but radiation hazard." },
  storage: { cabinet: "Radioactive storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents"] },
  transport: { un: "2976", class: "7", packingGroup: "N/A", properShipping: "Thorium nitrate, solid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

// ===== FIRE SUPPRESSION =====

chemicalHazardDB["Halon 1301"] = {
  cas: "75-63-8", formula: "CBrF₃",
  de: "Halon 1301", es: "Halón 1301", fr: "Halon 1301", pt: "Halon 1301",
  synonyms: ["Bromotrifluoromethane", "BTM"],
  classes: ["compressed"],
  ghs: ["GHS04"],
  hazardStatements: [
    { code: "H280", text: "Contains gas under pressure" }
  ],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: true, type: "SCBA in confined/post-fire" }, other: "Fire suppressant. OZONE DEPLETER - production banned (Montreal Protocol). Still in critical applications (aircraft, military). Decomposes to toxic products in fire." },
  storage: { cabinet: "Cylinder storage", temp: "Below 52°C", ventilation: "Normal", incompatible: ["Chemically stable"] },
  transport: { un: "1009", class: "2.2", packingGroup: "N/A", properShipping: "Bromotrifluoromethane" },
  firstAid: { inhalation: "Fresh air (caution - decomposition products).", skin: "Warm if frostbite.", eyes: "N/A", ingestion: "N/A" }
};

chemicalHazardDB["FM-200"] = {
  cas: "431-89-0", formula: "C₃HF₇",
  de: "FM-200", es: "FM-200", fr: "FM-200", pt: "FM-200",
  synonyms: ["HFC-227ea", "Heptafluoropropane", "Novec replacement"],
  classes: ["compressed"],
  ghs: ["GHS04"],
  hazardStatements: [
    { code: "H280", text: "Contains gas under pressure" }
  ],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: true, type: "SCBA post-discharge" }, other: "Halon replacement. Data centers, museums, aircraft. No ozone depletion but high GWP. Safe at design concentrations but can decompose in fire." },
  storage: { cabinet: "Cylinder storage", temp: "Below 52°C", ventilation: "Normal", incompatible: [] },
  transport: { un: "3296", class: "2.2", packingGroup: "N/A", properShipping: "Heptafluoropropane" },
  firstAid: { inhalation: "Fresh air.", skin: "N/A", eyes: "N/A", ingestion: "N/A" }
};

chemicalHazardDB["Novec 1230"] = {
  cas: "756-13-8", formula: "CF₃CF₂C(O)CF(CF₃)₂",
  de: "Novec 1230", es: "Novec 1230", fr: "Novec 1230", pt: "Novec 1230",
  synonyms: ["FK-5-1-12", "Fluoroketone"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Latest generation clean agent. Very low GWP (1), no ozone depletion. Liquid at room temp - floods as gas. Data centers, museums." },
  storage: { cabinet: "Cylinder storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Novec 1230" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Potassium Hydroxide"] = {
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Rubber gloves, apron" }, respiratory: { required: false, type: "Dust mask for flakes" }, other: "Soft soap production, alkaline batteries, food processing. More soluble than NaOH. Very hygroscopic." },
  storage: { cabinet: "Corrosive cabinet", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Acids", "Metals (aluminum, zinc)"] },
  transport: { un: "1813", class: "8", packingGroup: "II", properShipping: "Potassium hydroxide, solid" },
...
chemicalHazardDB["Silicone Sealant"] = {
  ...
  synonyms: ["RTV silicone", "Silicone caulk"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Ventilation" }, other: "Construction sealant. Releases acetic acid (vinegar smell) or oxime while curing. Fully cured product is inert." },
...
chemicalHazardDB["Polyurethane Foam"] = {
  cas: "Various", formula: "Isocyanate/Polyol",
  de: "Polyurethanschaum", es: "Espuma de poliuretano", fr: "Mousse polyuréthane", pt: "Espuma de poliuretano",
  synonyms: ["PU foam", "Spray foam", "Expanding foam"],
  classes: ["irritant", "health"],
  ghs: ["GHS07", "GHS08"],
  hazardStatements: [
    { code: "H315", text: "Causes skin irritation" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "Organic vapor/particulate" }, other: "Contains ISOCYANATES - respiratory sensitizer. Cured foam is safe. Professional spray foam requires full PPE." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Water (accelerates cure)"] },
  transport: { un: "1950", class: "2", packingGroup: "N/A", properShipping: "Aerosols" },
...
chemicalHazardDB["Magnesium Chloride"] = {
  cas: "7786-30-3", formula: "MgCl₂",
  de: "Magnesiumchlorid", es: "Cloruro de magnesio", fr: "Chlorure de magnésium", pt: "Cloreto de magnésio",
  synonyms: ["E511", "Nigari (food grade)"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "De-icing (less corrosive than NaCl), tofu coagulant (nigari), dust control. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: [] },
...
chemicalHazardDB["Manganese Dioxide"] = {
  cas: "1313-13-9", formula: "MnO₂",
  de: "Mangandioxid", es: "Dióxido de manganeso", fr: "Dioxyde de manganèse", pt: "Dióxido de manganês",
  synonyms: ["Pyrolusite", "Black oxide of manganese"],
  classes: ["oxidizer", "health"],
  ghs: ["GHS03", "GHS08"],
  hazardStatements: [
    { code: "H272", text: "May intensify fire; oxidizer" },
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "Particulate respirator" }, other: "Alkaline batteries, glassmaking, catalyst (H2O2 decomposition). Long-term Mn exposure → neurological effects (manganism)." },
  storage: { cabinet: "Oxidizer storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Organics"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Manganese dioxide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Cobalt Chloride"] = {
  cas: "7646-79-9", formula: "CoCl₂",
  de: "Cobaltchlorid", es: "Cloruro de cobalto", fr: "Chlorure de cobalt", pt: "Cloreto de cobalto",
  synonyms: ["Cobalt(II) chloride", "Cobaltous chloride"],
  classes: ["toxic", "health", "environmental"],
  ghs: ["GHS07", "GHS08", "GHS09"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "Particulate respirator" }, other: "CARCINOGEN, REPRODUCTIVE TOXIN. Humidity indicator (blue→pink), electroplating. Restricted in EU." },
  storage: { cabinet: "Toxic storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Metals", "Oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Cobalt chloride" },
  firstAid: { inhalation: "Fresh air. Medical attention.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth. Medical attention." }
};
...
chemicalHazardDB["Sodium Phosphate (Trisodium)"] = {
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Heavy-duty cleaner, degreaser, paint prep. Strongly alkaline (pH ~12). Being phased out due to eutrophication concerns." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Acids"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Trisodium phosphate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Drink water." }
};

// ===== BATCH 6: ADDITIONAL CHEMICALS =====

chemicalHazardDB["Potassium Dichromate"] = {
  cas: "7778-50-9", formula: "K₂Cr₂O₇",
  de: "Kaliumdichromat", es: "Dicromato de potasio", fr: "Dichromate de potassium", pt: "Dicromato de potássio",
  synonyms: ["Potassium bichromate"],
  classes: ["oxidizer", "toxic", "health", "environmental"],
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Full chemical suit" }, respiratory: { required: true, type: "Full-face respirator with P3 filter" }, other: "KNOWN CARCINOGEN. Hexavalent chromium Cr(VI). Laboratory reagent, leather tanning, wood preservation." },
  storage: { cabinet: "Oxidizer/toxic cabinet", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Organics", "Flammables"] },
  transport: { un: "3086", class: "5.1 (6.1)", packingGroup: "II", properShipping: "Toxic solid, oxidizing" },
  firstAid: { inhalation: "Fresh air. Medical attention.", skin: "Flush 30 min. Medical attention.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth. Medical attention." }
};
...
chemicalHazardDB["Sodium Dichromate"] = {
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Full chemical suit" }, respiratory: { required: true, type: "P3 respirator" }, other: "KNOWN CARCINOGEN. Hexavalent chromium. Wood treatment, corrosion inhibitor." },
  storage: { cabinet: "Oxidizer/toxic cabinet", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Organics"] },
  transport: { un: "3087", class: "5.1 (6.1)", packingGroup: "II", properShipping: "Oxidizing solid, toxic" },
  firstAid: { inhalation: "Fresh air. Medical attention.", skin: "Flush 30 min.", eyes: "Flush 30 min.", ingestion: "Rinse mouth. Medical attention." }
};

chemicalHazardDB["Molybdenum Disulfide"] = {
  cas: "1317-33-5", formula: "MoS₂",
  de: "Molybdändisulfid", es: "Disulfuro de molibdeno", fr: "Disulfure de molybdène", pt: "Dissulfeto de molibdênio",
  synonyms: ["Molybdenite", "Moly"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Dry lubricant. Very safe. Used in greases, coatings, 2D materials research. Black/gray powder." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Molybdenum disulfide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Tungsten Carbide"] = {
  cas: "12070-12-1", formula: "WC",
  de: "Wolframcarbid", es: "Carburo de tungsteno", fr: "Carbure de tungstène", pt: "Carboneto de tungstênio",
  synonyms: ["Wolfram carbide", "Cemented carbide"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Gloves" }, respiratory: { required: true, type: "Dust mask" }, other: "Cutting tools, drill bits. Very hard. Dust may cause hard metal lung disease with cobalt binder." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Tungsten carbide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Silicon Carbide"] = {
  cas: "409-21-2", formula: "SiC",
  de: "Siliciumcarbid", es: "Carburo de silicio", fr: "Carbure de silicium", pt: "Carboneto de silício",
  synonyms: ["Carborundum", "Moissanite"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Abrasive (sandpaper), semiconductors, brake pads. Very hard. Safe but dust is irritating." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Silicon carbide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Boron Nitride"] = {
  cas: "10043-11-5", formula: "BN",
  de: "Bornitrid", es: "Nitruro de boro", fr: "Nitrure de bore", pt: "Nitreto de boro",
  synonyms: ["White graphite", "Hexagonal BN"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "High-temp lubricant, cosmetics, thermal management. Very safe. Similar to graphite but white." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Boron nitride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};
...
chemicalHazardDB["Sodium Fluoride"] = {
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Water fluoridation, toothpaste, pesticide. TOXIC in pure form. Safe at low concentrations." },
  storage: { cabinet: "Toxic storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids"] },
  transport: { un: "1690", class: "6.1", packingGroup: "III", properShipping: "Sodium fluoride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Give calcium (milk). Medical attention." }
};
...
chemicalHazardDB["Potassium Fluoride"] = {
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: true, type: "Dust/mist respirator" }, other: "Fluorinating agent, etching glass, flux. More toxic than NaF. Hygroscopic." },
  storage: { cabinet: "Toxic storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Strong acids", "Glass (etches)"] },
  transport: { un: "1812", class: "6.1", packingGroup: "III", properShipping: "Potassium fluoride" },
  firstAid: { inhalation: "Fresh air. Medical attention.", skin: "Wash thoroughly.", eyes: "Flush 20 min.", ingestion: "Give calcium. Medical attention." }
};

chemicalHazardDB["Calcium Fluoride"] = {
  cas: "7789-75-5", formula: "CaF₂",
  de: "Calciumfluorid", es: "Fluoruro de calcio", fr: "Fluorure de calcium", pt: "Fluoreto de cálcio",
  synonyms: ["Fluorite", "Fluorspar"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Optics (UV-transparent), flux, HF production feedstock. Very insoluble - much safer than NaF/KF." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids (releases HF)"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Calcium fluoride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Lithium Carbonate"] = {
  cas: "554-13-2", formula: "Li₂CO₃",
  de: "Lithiumcarbonat", es: "Carbonato de litio", fr: "Carbonate de lithium", pt: "Carbonato de lítio",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Bipolar disorder treatment, ceramics, lithium battery precursor. Narrow therapeutic index - overdose dangerous." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Lithium carbonate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Medical attention (lithium toxicity)." }
};

chemicalHazardDB["Lithium Hydroxide"] = {
  cas: "1310-65-2", formula: "LiOH",
  de: "Lithiumhydroxid", es: "Hidróxido de litio", fr: "Hydroxyde de lithium", pt: "Hidróxido de lítio",
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "CO2 scrubber (submarines, spacecraft), lithium grease, battery electrolyte. Strong base." },
  storage: { cabinet: "Corrosive cabinet", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Acids", "CO2 (reacts)"] },
  transport: { un: "2680", class: "8", packingGroup: "II", properShipping: "Lithium hydroxide" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 30 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse. Do NOT vomit." }
};
...
chemicalHazardDB["Lithium Chloride"] = {
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Desiccant (very hygroscopic), lithium production, brazing flux. Historical antidepressant (toxic)." },
  storage: { cabinet: "General storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Moisture (hygroscopic)"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Lithium chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth. Medical attention if large amount." }
};
...
chemicalHazardDB["Cesium Chloride"] = {
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Density gradient centrifugation (DNA separation), radiation therapy. Expensive. Non-radioactive form is mildly irritating." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Cesium chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Rubidium Chloride"] = {
  ...
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Research chemical, biomedical research (K+ channel studies). Relatively safe. Expensive." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Rubidium chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Strontium Chloride"] = {
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Toothpaste (sensitive teeth), pyrotechnics (red flames), corrosion inhibitor. Safe at low concentrations." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Strontium chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Strontium Nitrate"] = {
  cas: "10042-76-9", formula: "Sr(NO₃)₂",
  de: "Strontiumnitrat", es: "Nitrato de estroncio", fr: "Nitrate de strontium", pt: "Nitrato de estrôncio",
  synonyms: [],
  classes: ["oxidizer", "irritant"],
  ghs: ["GHS03", "GHS07"],
  hazardStatements: [
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Pyrotechnics (red flames), signal flares, tracer ammunition. Oxidizer - keep away from fuels." },
  storage: { cabinet: "Oxidizer storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Organics", "Fuels"] },
  transport: { un: "1507", class: "5.1", packingGroup: "III", properShipping: "Strontium nitrate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Barium Nitrate"] = {
  cas: "10022-31-8", formula: "Ba(NO₃)₂",
  de: "Bariumnitrat", es: "Nitrato de bario", fr: "Nitrate de baryum", pt: "Nitrato de bário",
  synonyms: [],
  classes: ["oxidizer", "toxic"],
  ghs: ["GHS03", "GHS06"],
  hazardStatements: [
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Pyrotechnics (green flames), oxidizer. Barium is toxic - soluble barium salts are poisonous." },
  storage: { cabinet: "Oxidizer/toxic storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Sulfates"] },
  transport: { un: "1446", class: "5.1 (6.1)", packingGroup: "II", properShipping: "Barium nitrate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Give sodium sulfate solution. Medical attention." }
};

chemicalHazardDB["Barium Sulfate"] = {
  cas: "7727-43-7", formula: "BaSO₄",
  de: "Bariumsulfat", es: "Sulfato de bario", fr: "Sulfate de baryum", pt: "Sulfato de bário",
  synonyms: ["Barite", "Blanc fixe", "E172"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "X-ray contrast medium (barium swallow), paint filler, drilling mud. SAFE because insoluble - unlike other Ba salts." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Barium sulfate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe (used medically)." }
};

chemicalHazardDB["Aluminum Oxide"] = {
  cas: "1344-28-1", formula: "Al₂O₃",
  de: "Aluminiumoxid", es: "Óxido de aluminio", fr: "Oxyde d'aluminium", pt: "Óxido de alumínio",
  synonyms: ["Alumina", "Corundum", "Sapphire/Ruby (gem forms)"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Abrasive, catalyst support, refractory. Very hard (9 on Mohs scale). Safe but dust is irritating." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Aluminum oxide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Aluminum Hydroxide"] = {
  cas: "21645-51-2", formula: "Al(OH)₃",
  de: "Aluminiumhydroxid", es: "Hidróxido de aluminio", fr: "Hydroxyde d'aluminium", pt: "Hidróxido de alumínio",
  synonyms: ["Gibbsite", "Alumina trihydrate", "E173"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Antite (Maalox), flame retardant, vaccine adjuvant. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids", "Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Aluminum hydroxide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe (it IS an antacid)." }
};

chemicalHazardDB["Iron(III) Oxide"] = {
  cas: "1309-37-1", formula: "Fe₂O₃",
  de: "Eisen(III)-oxid", es: "Óxido de hierro(III)", fr: "Oxyde de fer(III)", pt: "Óxido de ferro(III)",
  synonyms: ["Hematite", "Rust", "Red iron oxide", "E172"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Pigment (red/brown), polishing compound (jeweler's rouge), thermite component. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Aluminum powder (thermite reaction)"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Iron oxide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Iron(II,III) Oxide"] = {
  cas: "1317-61-9", formula: "Fe₃O₄",
  de: "Eisen(II,III)-oxid", es: "Óxido de hierro(II,III)", fr: "Oxyde de fer(II,III)", pt: "Óxido de ferro(II,III)",
  synonyms: ["Magnetite", "Black iron oxide"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Magnetic material, pigment (black), MRI contrast (nanoparticles). Natural lodestone. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Iron oxide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Copper(I) Oxide"] = {
  cas: "1317-39-1", formula: "Cu₂O",
  de: "Kupfer(I)-oxid", es: "Óxido de cobre(I)", fr: "Oxyde de cuivre(I)", pt: "Óxido de cobre(I)",
  synonyms: ["Cuprous oxide", "Red copper oxide"],
  classes: ["toxic", "environmental"],
  ghs: ["GHS07", "GHS09"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Antifouling paint, semiconductor, red glass/ceramic pigment. Red-brown powder." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids"] },
  transport: { un: "3077", class: "9", packingGroup: "III", properShipping: "Environmentally hazardous substance" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Copper(II) Oxide"] = {
  cas: "1317-38-0", formula: "CuO",
  de: "Kupfer(II)-oxid", es: "Óxido de cobre(II)", fr: "Oxyde de cuivre(II)", pt: "Óxido de cobre(II)",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Catalyst, pigment (black), semiconductor, welding flux. Black powder." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Aluminum (thermite)"] },
  transport: { un: "3077", class: "9", packingGroup: "III", properShipping: "Environmentally hazardous substance" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Silver Chloride"] = {
  cas: "7783-90-6", formula: "AgCl",
  de: "Silberchlorid", es: "Cloruro de plata", fr: "Chlorure d'argent", pt: "Cloreto de prata",
  synonyms: ["Cerargyrite"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Photography, reference electrodes, antidote for mercury poisoning. Light-sensitive (darkens). Very insoluble - safe." },
  storage: { cabinet: "General storage (dark)", temp: "Room temperature", ventilation: "Normal", incompatible: ["Light", "Ammonia (forms explosive)"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Silver chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe (insoluble)." }
};

chemicalHazardDB["Gold(III) Chloride"] = {
  cas: "13453-07-1", formula: "AuCl₃",
  de: "Gold(III)-chlorid", es: "Cloruro de oro(III)", fr: "Chlorure d'or(III)", pt: "Cloreto de ouro(III)",
  synonyms: ["Auric chloride", "Gold trichloride"],
  classes: ["corrosive"],
  ghs: ["GHS05"],
  hazardStatements: [
    { code: "H314", text: "Causes severe skin burns and eye damage" }
  ],
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "N/A" }, other: "Gold plating, catalysis, photography. Reddish-brown. Hygroscopic and corrosive. Expensive." },
  storage: { cabinet: "Corrosive cabinet", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Moisture", "Reducing agents"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Gold(III) chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 20 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Platinum(IV) Chloride"] = {
  cas: "13454-96-1", formula: "PtCl₄",
  de: "Platin(IV)-chlorid", es: "Cloruro de platino(IV)", fr: "Chlorure de platine(IV)", pt: "Cloreto de platina(IV)",
  synonyms: ["Platinic chloride"],
  classes: ["irritant", "health"],
  ghs: ["GHS07", "GHS08"],
  hazardStatements: [
    { code: "H317", text: "May cause allergic skin reaction" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "Particulate respirator" }, other: "Catalyst preparation, platinum plating. SENSITIZER - can cause 'platinosis' (respiratory allergy). Brown-red." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Platinum chloride" },
  firstAid: { inhalation: "Fresh air. Medical attention if breathing difficulties.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Palladium(II) Chloride"] = {
  cas: "7647-10-1", formula: "PdCl₂",
  de: "Palladium(II)-chlorid", es: "Cloruro de paladio(II)", fr: "Chlorure de palladium(II)", pt: "Cloreto de paládio(II)",
  synonyms: ["Palladous chloride"],
  classes: ["irritant", "health"],
  ghs: ["GHS07", "GHS08"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Catalyst (Pd/C preparation), CO detector, electroless plating. Dark red-brown. Sensitizer." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Palladium chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Zinc Chloride"] = {
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Soldering flux, wood preservative, dry cell batteries. Very hygroscopic. Corrosive when concentrated." },
  storage: { cabinet: "Corrosive cabinet", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Potassium", "Water (exothermic)"] },
  transport: { un: "2331", class: "8", packingGroup: "III", properShipping: "Zinc chloride, anhydrous" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 20 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Give milk. Medical attention." }
};

chemicalHazardDB["Magnesium Hydroxide"] = {
  cas: "1309-42-8", formula: "Mg(OH)₂",
  de: "Magnesiumhydroxid", es: "Hidróxido de magnesio", fr: "Hydroxyde de magnésium", pt: "Hidróxido de magnésio",
  synonyms: ["Milk of magnesia", "Brucite", "E528"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Antacid, laxative, flame retardant, wastewater treatment. Very safe. White powder or suspension." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong acids"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Magnesium hydroxide" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe (it's medicine)." }
};

chemicalHazardDB["Sodium Percarbonate"] = {
  cas: "15630-89-4", formula: "2Na₂CO₃·3H₂O₂",
  de: "Natriumpercarbonat", es: "Percarbonato de sodio", fr: "Percarbonate de sodium", pt: "Percarbonato de sódio",
  synonyms: ["Sodium carbonate peroxyhydrate", "Oxygen bleach"],
  classes: ["oxidizer", "irritant"],
  ghs: ["GHS03", "GHS07"],
  hazardStatements: [
    { code: "H272", text: "May intensify fire; oxidizer" },
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Oxygen bleach (OxiClean), laundry booster. Releases H2O2 in water. Safer than chlorine bleach." },
  storage: { cabinet: "Oxidizer storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Reducing agents", "Moisture (decomposes)"] },
  transport: { un: "3378", class: "5.1", packingGroup: "II", properShipping: "Sodium percarbonate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 30 min. Medical attention.", ingestion: "Drink water. Medical attention." }
};

chemicalHazardDB["Sodium Perborate"] = {
  cas: "15120-21-5", formula: "NaBO₃·H₂O",
  de: "Natriumperborat", es: "Perborato de sodio", fr: "Perborate de sodium", pt: "Perborato de sódio",
  synonyms: ["Sodium peroxoborate"],
  classes: ["oxidizer", "toxic", "health"],
  ghs: ["GHS03", "GHS07", "GHS08"],
  hazardStatements: [
    { code: "H272", text: "May intensify fire; oxidizer" },
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Chemical goggles" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "REPRODUCTIVE TOXIN (boron). Laundry bleach, disinfectant. Being replaced by percarbonate. Releases H2O2." },
  storage: { cabinet: "Oxidizer storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Reducing agents", "Acids"] },
  transport: { un: "3377", class: "5.1", packingGroup: "III", properShipping: "Sodium perborate monohydrate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 30 min. Medical attention.", ingestion: "Rinse mouth. Medical attention." }
};

// ===== BATCH 7: FINAL EXPANSION =====

chemicalHazardDB["Sodium Metasilicate"] = {
  cas: "6834-92-0", formula: "Na₂SiO₃",
  de: "Natriummetasilikat", es: "Metasilicato de sodio", fr: "Métasilicate de sodium", pt: "Metassilicato de sódio",
  synonyms: ["Water glass (solution)", "Sodium silicate"],
  classes: ["corrosive"],
  ghs: ["GHS05", "GHS07"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Heavy-duty detergent builder, concrete sealer, fireproofing. Strongly alkaline (pH ~12.5). Corrosive." },
  storage: { cabinet: "Corrosive cabinet", temp: "Room temperature", ventilation: "Normal", incompatible: ["Acids", "Metals (aluminum, zinc)"] },
  transport: { un: "3253", class: "8", packingGroup: "II", properShipping: "Sodium metasilicate" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 20 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Drink water. Do NOT vomit." }
};

chemicalHazardDB["Sodium Aluminate"] = {
  cas: "11138-49-1", formula: "NaAlO₂",
  de: "Natriumaluminat", es: "Aluminato de sodio", fr: "Aluminate de sodium", pt: "Aluminato de sódio",
  synonyms: [],
  classes: ["corrosive"],
  ghs: ["GHS05"],
  hazardStatements: [
  ...
  ppe: { eyes: { required: true, type: "Face shield + chemical goggles" }, skin: { required: true, type: "Rubber gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "Water treatment (coagulant), paper production, cement additive. Strongly alkaline. White powder." },
  storage: { cabinet: "Corrosive cabinet", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Acids", "Water (exothermic)"] },
  transport: { un: "2812", class: "8", packingGroup: "II", properShipping: "Sodium aluminate" },
  firstAid: { inhalation: "Fresh air.", skin: "Flush 20 min.", eyes: "Flush 30 min. Medical attention.", ingestion: "Do NOT vomit. Medical attention." }
};

chemicalHazardDB["Calcium Sulfate"] = {
  cas: "7778-18-9", formula: "CaSO₄",
  de: "Calciumsulfat", es: "Sulfato de calcio", fr: "Sulfate de calcium", pt: "Sulfato de cálcio",
  synonyms: ["Gypsum", "Plaster of Paris", "E516"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Plaster, drywall, food additive (E516 - tofu coagulant). Very safe. Exothermic when setting." },
  storage: { cabinet: "General storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Aluminum powder (exothermic)"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Calcium sulfate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};
...
chemicalHazardDB["Sodium Sulfate"] = {
  cas: "7757-82-6", formula: "Na₂SO₄",
  de: "Natriumsulfat", es: "Sulfato de sodio", fr: "Sulfate de sodium", pt: "Sulfato de sódio",
  synonyms: ["Glauber's salt", "Salt cake", "E514"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Detergent filler, paper production, glass making. Very safe. Historical laxative (Glauber's salt)." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Aluminum powder"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Sodium sulfate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe (but laxative effect)." }
};

chemicalHazardDB["Potassium Sulfate"] = {
  cas: "7778-80-5", formula: "K₂SO₄",
  de: "Kaliumsulfat", es: "Sulfato de potasio", fr: "Sulfate de potassium", pt: "Sulfato de potássio",
  synonyms: ["Potash of sulfur", "SOP", "E515"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Fertilizer (potassium source), food additive (E515). Chloride-free K source. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Potassium sulfate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Sodium Acetate"] = {
  cas: "127-09-3", formula: "CH₃COONa",
  de: "Natriumacetat", es: "Acetato de sodio", fr: "Acétate de sodium", pt: "Acetato de sódio",
  synonyms: ["E262", "Hot ice (supersaturated)"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Food preservative (E262), heat packs (supersaturated solution), buffer. Very safe. Vinegar smell." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Sodium acetate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Potassium Acetate"] = {
  cas: "127-08-2", formula: "CH₃COOK",
  de: "Kaliumacetat", es: "Acetato de potasio", fr: "Acétate de potassium", pt: "Acetato de potássio",
  synonyms: ["E261"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Food preservative (E261), de-icing (airport runways - less corrosive than NaCl). Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Potassium acetate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Calcium Acetate"] = {
  cas: "62-54-4", formula: "(CH₃COO)₂Ca",
  de: "Calciumacetat", es: "Acetato de calcio", fr: "Acétate de calcium", pt: "Acetato de cálcio",
  synonyms: ["E263", "Lime acetate"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Food additive (E263), phosphate binder (kidney disease), fuel gel (Sterno). Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Calcium acetate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Zinc Acetate"] = {
  cas: "557-34-6", formula: "(CH₃COO)₂Zn",
  de: "Zinkacetat", es: "Acetato de zinc", fr: "Acétate de zinc", pt: "Acetato de zinco",
  synonyms: [],
  classes: ["irritant", "environmental"],
  ghs: ["GHS07", "GHS09"],
  hazardStatements: [
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "N/A" }, other: "Wood preservative, dietary supplement, cold remedy (lozenges). Mild emetic at high doses." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Zinc acetate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Give milk. Medical attention if large amount." }
};

chemicalHazardDB["Lead(II) Nitrate"] = {
  cas: "10099-74-8", formula: "Pb(NO₃)₂",
  de: "Blei(II)-nitrat", es: "Nitrato de plomo(II)", fr: "Nitrate de plomb(II)", pt: "Nitrato de chumbo(II)",
  synonyms: ["Lead nitrate"],
  classes: ["oxidizer", "toxic", "health", "environmental"],
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: true, type: "P3 particulate respirator" }, other: "LEAD COMPOUND - cumulative poison. Gold refining, matches (historical), pigment. White crystals." },
  storage: { cabinet: "Oxidizer/toxic cabinet", temp: "Room temperature", ventilation: "Normal", incompatible: ["Reducing agents", "Carbon", "Sulfur"] },
  transport: { un: "1469", class: "5.1 (6.1)", packingGroup: "II", properShipping: "Lead nitrate" },
  firstAid: { inhalation: "Fresh air. Medical attention.", skin: "Wash thoroughly.", eyes: "Flush 15 min.", ingestion: "Medical attention. Lead poisoning treatment." }
};

chemicalHazardDB["Sodium Formate"] = {
  cas: "141-53-7", formula: "HCOONa",
  de: "Natriumformiat", es: "Formiato de sodio", fr: "Formiate de sodium", pt: "Formiato de sódio",
  synonyms: ["E237"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "De-icing (eco-friendly), leather tanning, oil drilling. Biodegradable. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Sodium formate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Potassium Formate"] = {
  cas: "590-29-4", formula: "HCOOK",
  de: "Kaliumformiat", es: "Formiato de potasio", fr: "Formiate de potassium", pt: "Formiato de potássio",
  synonyms: [],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "High-density brine (oil drilling), de-icing. Very soluble. Environmentally friendly. Safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Potassium formate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Ammonium Formate"] = {
  cas: "540-69-2", formula: "HCOONH₄",
  de: "Ammoniumformiat", es: "Formiato de amonio", fr: "Formiate d'ammonium", pt: "Formiato de amônio",
  synonyms: [],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Buffer, reducing agent, LC-MS mobile phase additive. Decomposes above 180°C. Safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers", "Strong bases (releases NH3)"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Ammonium formate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Rinse mouth." }
};
...
chemicalHazardDB["Ammonium Chloride"] = {
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Flux (soldering), batteries, food additive (E510), expectorant. Sublimes on heating." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases (releases NH3)", "Silver salts"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Ammonium chloride" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Drink water. Medical attention if large amount." }
};

chemicalHazardDB["Ammonium Carbonate"] = {
  cas: "506-87-6", formula: "(NH₄)₂CO₃",
  de: "Ammoniumcarbonat", es: "Carbonato de amonio", fr: "Carbonate d'ammonium", pt: "Carbonato de amônio",
  synonyms: ["Baker's ammonia", "Hartshorn", "E503"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H302", text: "Harmful if swallowed" },
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Ventilation" }, other: "Baking (leavening agent), smelling salts. Decomposes to CO2 + NH3 on heating (no residue in baked goods)." },
  storage: { cabinet: "General storage", temp: "Room temperature, sealed", ventilation: "Normal", incompatible: ["Acids"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Ammonium carbonate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Ammonium Phosphate (Dibasic)"] = {
  cas: "7783-28-0", formula: "(NH₄)₂HPO₄",
  de: "Diammoniumhydrogenphosphat", es: "Fosfato de amonio dibásico", fr: "Phosphate d'ammonium dibasique", pt: "Fosfato de amônio dibásico",
  synonyms: ["DAP", "Diammonium phosphate", "E342"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Fertilizer (N+P), food additive (E342), fire retardant. Very safe. Yeast nutrient in winemaking." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases (releases NH3)"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Diammonium phosphate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Monoammonium Phosphate"] = {
  cas: "7722-76-1", formula: "NH₄H₂PO₄",
  de: "Ammoniumdihydrogenphosphat", es: "Fosfato de monoamonio", fr: "Phosphate de monoammonium", pt: "Fosfato de monoamônio",
  synonyms: ["MAP", "E342"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Fire extinguisher (ABC powder), fertilizer, food additive. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Monoammonium phosphate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Sodium Hexametaphosphate"] = {
  cas: "68915-31-1", formula: "(NaPO₃)₆",
  de: "Natriumhexametaphosphat", es: "Hexametafosfato de sodio", fr: "Hexamétaphosphate de sodium", pt: "Hexametafosfato de sódio",
  synonyms: ["SHMP", "Calgon", "E452i"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Water softener, food additive (E452), detergent builder, scale prevention. Safe. White powder." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Sodium hexametaphosphate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["EDTA Disodium Salt"] = {
  cas: "6381-92-6", formula: "C₁₀H₁₄N₂Na₂O₈",
  de: "EDTA-Dinatriumsalz", es: "EDTA sal disódica", fr: "EDTA sel disodique", pt: "EDTA sal dissódico",
  synonyms: ["Disodium EDTA", "Edetate disodium", "E386"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H319", text: "Causes serious eye irritation" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Chelating agent (removes metal ions), food preservative (E386), lead poisoning treatment, water softening." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "EDTA disodium salt" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth." }
};

chemicalHazardDB["Thiourea"] = {
  cas: "62-56-6", formula: "CH₄N₂S",
  de: "Thioharnstoff", es: "Tiourea", fr: "Thiourée", pt: "Tioureia",
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: true, type: "Gloves" }, respiratory: { required: false, type: "Dust mask" }, other: "SUSPECTED CARCINOGEN. Photography, rubber vulcanization, metal cleaning. Thyroid disruptor." },
  storage: { cabinet: "General/toxic storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Thiourea" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Rinse mouth. Medical attention." }
};

chemicalHazardDB["Citric Acid Monohydrate"] = {
  cas: "5949-29-1", formula: "C₆H₈O₇·H₂O",
  de: "Citronensäure-Monohydrat", es: "Ácido cítrico monohidrato", fr: "Acide citrique monohydrate", pt: "Ácido cítrico mono-hidratado",
  synonyms: ["E330"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
  ...
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Food acidulant, preservative, cleaning. Most common food acid. Natural fruit acid. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers", "Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Citric acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Safe." }
};
...
chemicalHazardDB["Ascorbic Acid"] = {
  ...
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Essential vitamin, antioxidant, food preservative (E300). Very safe. Slightly acidic." },
  storage: { cabinet: "General storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Strong oxidizers (degrades)"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Ascorbic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe (it's a vitamin)." }
};

chemicalHazardDB["Sodium Ascorbate"] = {
  cas: "134-03-2", formula: "C₆H₇NaO₆",
  de: "Natriumascorbat", es: "Ascorbato de sodio", fr: "Ascorbate de sodium", pt: "Ascorbato de sódio",
  synonyms: ["E301", "Sodium vitamin C"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Vitamin C supplement (buffered, non-acidic), food antioxidant (E301). Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature, dry", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Sodium ascorbate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};
...
chemicalHazardDB["Malic Acid"] = {
  cas: "6915-15-7", formula: "C₄H₆O₅",
  de: "Apfelsäure", es: "Ácido málico", fr: "Acide malique", pt: "Ácido málico",
  synonyms: ["E296", "Hydroxysuccinic acid"],
  classes: ["irritant"],
  ghs: ["GHS07"],
  hazardStatements: [
    { code: "H319", text: "Causes serious eye irritation" }
  ],
  ppe: { eyes: { required: true, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Food acidulant (sour candies), wine (malolactic fermentation), skin care. Natural apple acid. Safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Malic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush 15 min.", ingestion: "Safe." }
};

chemicalHazardDB["Succinic Acid"] = {
  cas: "110-15-6", formula: "C₄H₆O₄",
  de: "Bernsteinsäure", es: "Ácido succínico", fr: "Acide succinique", pt: "Ácido succínico",
  synonyms: ["E363", "Butanedioic acid", "Amber acid"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Food additive (E363), pharmaceutical, metabolic intermediate. Found in amber (hence name). Safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong bases"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Succinic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Gluconic Acid"] = {
  cas: "526-95-4", formula: "C₆H₁₂O₇",
  de: "Gluconsäure", es: "Ácido glucónico", fr: "Acide gluconique", pt: "Ácido glucônico",
  synonyms: ["Dextronic acid", "E574"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "Mild organic acid from glucose oxidation. Food additive, metal cleaning, concrete retarder. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Gluconic acid" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Sodium Gluconate"] = {
  cas: "527-07-1", formula: "C₆H₁₁NaO₇",
  de: "Natriumgluconat", es: "Gluconato de sodio", fr: "Gluconate de sodium", pt: "Gluconato de sódio",
  synonyms: ["E576"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Concrete admixture (retarder), metal cleaning (chelator), food additive. Very safe. Excellent biodegradability." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Sodium gluconate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Calcium Gluconate"] = {
  cas: "299-28-5", formula: "C₁₂H₂₂CaO₁₄",
  de: "Calciumgluconat", es: "Gluconato de calcio", fr: "Gluconate de calcium", pt: "Gluconato de cálcio",
  synonyms: ["E578"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "N/A" }, other: "HF BURN ANTIDOTE (gel + injection), calcium supplement, food additive. Essential emergency treatment for HF exposure." },
  storage: { cabinet: "General/emergency storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Calcium gluconate" },
  firstAid: { inhalation: "N/A", skin: "Used AS treatment for HF burns.", eyes: "N/A", ingestion: "Safe (it's a supplement)." }
};

chemicalHazardDB["Ferrous Gluconate"] = {
  cas: "299-29-6", formula: "C₁₂H₂₂FeO₁₄",
  de: "Eisen(II)-gluconat", es: "Gluconato ferroso", fr: "Gluconate ferreux", pt: "Gluconato ferroso",
  synonyms: ["Iron(II) gluconate", "E579"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Iron supplement, olive blackening (E579). Better tolerated than ferrous sulfate. Green-yellow." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: ["Strong oxidizers"] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Ferrous gluconate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe at supplement doses." }
};

chemicalHazardDB["Zinc Gluconate"] = {
  cas: "4468-02-4", formula: "C₁₂H₂₂O₁₄Zn",
  de: "Zinkgluconat", es: "Gluconato de zinc", fr: "Gluconate de zinc", pt: "Gluconato de zinco",
  synonyms: [],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Zinc supplement, cold lozenges. Better absorbed than ZnO. Safe at supplement doses." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Zinc gluconate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Magnesium Citrate"] = {
  cas: "3344-18-1", formula: "C₁₂H₁₀Mg₃O₁₄",
  de: "Magnesiumcitrat", es: "Citrato de magnesio", fr: "Citrate de magnésium", pt: "Citrato de magnésio",
  synonyms: ["E345"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Magnesium supplement, laxative (bowel prep), food acidity regulator. Good bioavailability. Safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Magnesium citrate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe (laxative effect at high doses)." }
};

chemicalHazardDB["Potassium Citrate"] = {
  cas: "866-84-2", formula: "C₆H₅K₃O₇",
  de: "Kaliumcitrat", es: "Citrato de potasio", fr: "Citrate de potassium", pt: "Citrato de potássio",
  synonyms: ["E332", "Tripotassium citrate"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Kidney stone prevention, food additive (E332), potassium supplement. Alkalinizes urine. Safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Potassium citrate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Trisodium Citrate"] = {
  cas: "68-04-2", formula: "C₆H₅Na₃O₇",
  de: "Trinatriumcitrat", es: "Citrato trisódico", fr: "Citrate trisodique", pt: "Citrato trissódico",
  synonyms: ["Sodium citrate", "E331iii"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Blood anticoagulant (blood bags), food additive (E331), buffer. Sour-salty taste. Very safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Trisodium citrate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

chemicalHazardDB["Calcium Citrate"] = {
  cas: "813-94-5", formula: "Ca₃(C₆H₅O₇)₂",
  de: "Calciumcitrat", es: "Citrato de calcio", fr: "Citrate de calcium", pt: "Citrato de cálcio",
  synonyms: ["E333", "Tricalcium citrate"],
  classes: [],
  ghs: [],
  hazardStatements: [],
  ppe: { eyes: { required: false, type: "Safety glasses" }, skin: { required: false, type: "Optional" }, respiratory: { required: false, type: "Dust mask" }, other: "Calcium supplement (can take without food), food additive (E333). Better absorbed than CaCO3. Safe." },
  storage: { cabinet: "General storage", temp: "Room temperature", ventilation: "Normal", incompatible: [] },
  transport: { un: "Not regulated", class: "N/A", packingGroup: "N/A", properShipping: "Calcium citrate" },
  firstAid: { inhalation: "Fresh air.", skin: "Wash.", eyes: "Flush.", ingestion: "Safe." }
};

// ========================================
// 🎉 CHEMICAL DATABASE: 500 CHEMICALS!
// ========================================
