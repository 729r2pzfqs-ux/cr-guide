...
# Additional high-value chemicals (German -> English slug)
MORE_CHEMICALS = {
    'Anilin': 'aniline',
    'Pyridin': 'pyridine',
    'Harnstoff': 'urea',
    ...
    'Dimethylformamid (DMF)': 'dmf',
    'Dimethylsulfoxid (DMSO)': 'dmso',
    'Formaldehydlösung': 'formaldehyde',
...
for chem in data:
    if chem['name'] not in MORE_CHEMICALS:
        continue
    
    en_slug = MORE_CHEMICALS[chem['name']]
    if en_slug in processed:
        continue
...
print(f"✅ Added {added} more chemicals, {pages} pages")
